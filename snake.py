...
def runGame():
    ...
    while True: # main game loop
        ...
        # check if snek has eaten an apply
        if wormCoords[HEAD]['x'] == apple['x'] and wormCoords[HEAD]['y'] == apple['y']:
            # don't remove snake's tail segment
            apple = getRandomLocation() # set a new apple somewhere
        else:
            del wormCoords[-1] # remove snake tail segment
...
def showStartScreen():
    ...
    while True:
        ...
        gameSurf = gameOverFont.render('Snake', True, WHITE)
        overSurf = gameOverFont.render('Pyhton', True, WHITE)
